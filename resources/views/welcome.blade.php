                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-sm-10">
                        <div class="text-center mt-lg-5 pt-5">
                            <h1 class="display-6 fw-semibold mb-3 lh-base">Platform Asisten Mahasiswa yang Akan Membantu <span
                                    class="text-success">Perkuliahanmu </span></h1>
                            <p class="lead text-muted lh-base">Si Asis kini hadir untuk membantu mahasiswa untuk memanajemen tugas supaya lebih produktif, dan mudah dalam mengatur tugas dan waktu.</p>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="text-center mb-5">
                            <h1 class="mb-3 ff-secondary fw-semibold lh-base">Temukan semua kemudahan yang akan membuatmu kuliah lebih tenang</h1>
                            <p class="text-muted">Sebagai Asisten terbaik pada saat ini, kami akan memberikan banyak kemudahan yang akan kamu rasakan, beberapa kemudahan tersebut sebagai berikut</p>
                        </div>
                    </div>
                    <!-- end col -->
                </div>
